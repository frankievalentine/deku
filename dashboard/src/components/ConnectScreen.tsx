...
export default function ConnectScreen({ onConnected }: ConnectScreenProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!valid) {
        setError('Invalid token. Read it from ~/.deku/cli-token on the Deku host.');
        return;
      }
    ...
    <div className="connect-shell">
      <div className="connect-card">
        ...
        <p className="connect-copy">
          Paste the JWT token generated by `dekud`. The daemon writes it to{' '}
          <code>~/.deku/cli-token</code> on startup.
        </p>
